# Generated by Django 2.1.7 on 2019-05-20 06:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='learn_app.Course', verbose_name='Курс')),
            ],
        ),
        migrations.CreateModel(
            name='Material',
            fields=[
                ...
                ('lesson', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='learn_app.Lesson')),
            ],
        ),
        migrations.CreateModel(
            name='MaterialType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answers', models.CharField(help_text='Введите варианты ответов через , ', max_length=200, null=True, verbose_name='Варианты ответов (вводить через ",")')),
            ],
        ),
        migrations.CreateModel(
            name='TeacherGroup',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='learn_app.Question')),
        ...
        migrations.AddField(
            model_name='material',
            name='material_type',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='learn_app.MaterialType', verbose_name='Тип дополнительного материала'),
        ),
        migrations.AddField(
            model_name='homework',
            name='lesson',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='learn_app.Lesson', verbose_name='Урок'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
